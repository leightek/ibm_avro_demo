...
public class Balance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Balance(String balanceId, String accountId, Float balance) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: balanceId = (String)value$; break;
    case 1: accountId = (String)value$; break;
    case 2: balance = (Float)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Balance>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBalanceId(String value) {
    ...
    public Balance build() {
      try {
        ...
        record.balanceId = fieldSetFlags()[0] ? this.balanceId : (String) defaultValue(fields()[0]);
        record.accountId = fieldSetFlags()[1] ? this.accountId : (String) defaultValue(fields()[1]);
        record.balance = fieldSetFlags()[2] ? this.balance : (Float) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
